...
func RegisterDefaults(scheme *runtime.Scheme) error {
	...
	scheme.AddTypeDefaultingFunc(&PeaksArgs{}, func(obj interface{}) { SetObjectDefaults_PeaksArgs(obj.(*PeaksArgs)) })
...
func SetObjectDefaults_PeaksArgs(in *PeaksArgs) {
	SetDefaults_PeaksArgs(in)
}
