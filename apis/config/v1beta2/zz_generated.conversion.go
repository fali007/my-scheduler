...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*PeaksArgs)(nil), (*config.PeaksArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_PeaksArgs_To_config_PeaksArgs(a.(*PeaksArgs), b.(*config.PeaksArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.PeaksArgs)(nil), (*PeaksArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_PeaksArgs_To_v1beta2_PeaksArgs(a.(*config.PeaksArgs), b.(*PeaksArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta2_PeaksArgs_To_config_PeaksArgs(in *PeaksArgs, out *config.PeaksArgs, s conversion.Scope) error {
...
// Convert_v1beta2_PeaksArgs_To_config_PeaksArgs is an autogenerated conversion function.
func Convert_v1beta2_PeaksArgs_To_config_PeaksArgs(in *PeaksArgs, out *config.PeaksArgs, s conversion.Scope) error {
	return autoConvert_v1beta2_PeaksArgs_To_config_PeaksArgs(in, out, s)
}

func autoConvert_config_PeaksArgs_To_v1beta2_PeaksArgs(in *config.PeaksArgs, out *PeaksArgs, s conversion.Scope) error {
...
// Convert_config_PeaksArgs_To_v1beta2_PeaksArgs is an autogenerated conversion function.
func Convert_config_PeaksArgs_To_v1beta2_PeaksArgs(in *config.PeaksArgs, out *PeaksArgs, s conversion.Scope) error {
	return autoConvert_config_PeaksArgs_To_v1beta2_PeaksArgs(in, out, s)
}
