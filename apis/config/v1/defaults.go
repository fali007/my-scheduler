...
// SetDefaults_TargetLoadPackingArgs sets the default parameters for PeaksArgs plugin
func SetDefaults_PeaksArgs(args *PeaksArgs) {
	if args.WatcherAddress == nil {
		address := "http://172.21.152.81:2020"
		args.WatcherAddress = &address
	}
}
